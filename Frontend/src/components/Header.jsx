  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link
          to="/"
          className="text-3xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 hover:scale-105 transition-transform duration-300"
        >
          🎮 Scar Games
        </Link>
        <nav className="flex space-x-8 text-lg font-medium">
          ...
          <Link
            ...
            // onClick={userLoggedIn ? handleLogout : undefined} // Logout handler on click
            className="relative text-white hover:text-yellow-300 transition-all duration-300 hover:scale-105"
          >
            <span className="pb-1 border-b-2 border-transparent hover:border-yellow-300 transition-all duration-300">
