      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6">
          ...
          <motion.button
            ...
            className="cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto px-10 w-48 py-4 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 text-white text-lg font-semibold rounded-full shadow-lg hover:shadow-blue-400/60 transition-all duration-500 tracking-wide backdrop-blur-md"
          >
            Confirm Order
          </motion.button>
        </div>
