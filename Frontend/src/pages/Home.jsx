...
const LeftArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute z-10 top-1/2 left-3 transform -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#fad73c]/20 transition"
  >
...
const RightArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute top-1/2 right-3 transform -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-[#fad73c]/20 transition"
  >
    ...
    <div className="bg-[#0f0c29] text-white">
      ...
      <div className="relative w-full h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Dive into the ultimate gaming universe — powered by neon energy!
          </motion.p>
        </div>
      </div>
        ...
        <div className="flex justify-center mb-10">
          ...
          >
            <button
              ...
              className="bg-gradient-to-r cursor-pointer from-[#00d2ff] to-[#ff1c8e] text-white px-6 py-3 rounded-full text-lg font-semibold shadow-lg hover:from-[#ff1c8e] hover:to-[#00d2ff] transition-all duration-300"
            >
            ...
            {filteredGames.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-6 text-center text-2xl font-bold bg-gradient-to-r from-yellow-400 to-pink-500 bg-clip-text text-transparent tracking-wide drop-shadow-sm">
                    {item.title}
                  </h3>
