...
export default function OrderSummary() {
  ...
  const handleConfirmOrder = async () => {
    const order = { total_amount: total, user_id: "33", status: "Processing" };
    const data = await dispatch(createOrder(order));
    // console.log("order: ", data.data[0].order_id);
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto space-y-12 py-10 px-4">
        <motion.h2
          className="text-5xl font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 drop-shadow-xl"
